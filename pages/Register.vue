          ...
          <div class="col-lg-5 mx-auto">
            <div class="form-action-wrapper py-5">
              ...
              <div class="form-group">
                ...
                <!-- Validation Error -->
                <span class="text-danger">{{this.ValidationErrors.response ?
                this.ValidationErrors.response.data.errors.name[0] : null}}</span>
              </div>
              <!-- end form-group -->
              <div class="form-group">
                ...
                <!-- Validation Error -->
                <span class="text-danger">{{this.ValidationErrors.response ?
                this.ValidationErrors.response.data.errors.email[0] : null}}</span>
              </div>
              <!-- end form-group -->
              <!-- end form-group -->
              <div class="form-group">
                <label class="fs-14 text-black fw-medium lh-18">Passowrd</label>
                <input type="password" v-model="password" class="form-control form--control"
                  placeholder="Email address" />
                <!-- Validation Error -->
                <span class="text-danger">{{this.ValidationErrors.response ?
                this.ValidationErrors.response.data.errors.password[0] : null}}</span>
              </div>
              <!-- end form-group -->
              <!-- end form-group -->
              <div class="form-group">
