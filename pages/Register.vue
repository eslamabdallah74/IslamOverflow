  ...
  methods: {
    async handleSubmit(e) {
      ...
      if (this.password === this.password_confirmation) {
        ...
        try {
          // Clear Valdation
          document.getElementById("nameValdation").innerHTML = '';
          ...
          let res = await this.$axios
            ...
            .catch(function (err) {
              ...
              if ((err.response.status = 422)) {
                erros = err.response.data.errors;
                document.getElementById("nameValdation").innerHTML = erros.name[0];
                document.getElementById("EmailValdation").innerHTML = erros.email[0];
                document.getElementById("PasswordValdation").innerHTML = erros.password[0];
                console.log(erros)
              }
            });
...
<template>
  <section class="sign-up-area pt-80px pb-80px position-relative">
    <div class="container">
      <form @submit.prevent="handleSubmit" class="card card-item">
        <div class="card-body row p-0">
          <div class="col-lg-6">
            <div class="
                ...
                radius-top-left-8 radius-bottom-left-8
                text-left
              ">
              <h3 class="fs-35 pb-4 fw-bold text-white w-100">
              ...
              <div class="hero-list w-100">
                <div class="d-flex align-items-center pb-30px">
                  ...
                  <p class="fs-15 text-white lh-20 fw-medium">
                    Get unstuck — ask a question
                  </p>
                </div>
                <div class="d-flex align-items-center pb-30px">
                  <svg width="26" height="26" class="mr-2">
                    <path fill="#ffffff" d="M12 .7a2 2 0 013 0l8.5 9.6a1 1 0 01-.7 1.7H4.2a1 1 0 01-.7-1.7L12 .7z">
                    </path>
                    <path fill="#ffffff" opacity=".5"
          ...
          <div class="col-lg-5 mx-auto">
            <div class="form-action-wrapper py-5">
              ...
              <div class="form-group">
                ...
                <input type="text" v-model="name" class="form-control form--control" placeholder="Enter name" />
                <!-- Validation Error -->
                <span class="text-danger" id="nameValdation"></span>
              </div>
              <!-- end form-group -->
              <div class="form-group">
                <label class="fs-14 text-black fw-medium lh-18">Email</label>
                <input type="email" v-model="email" class="form-control form--control" placeholder="Email address" />
                <!-- Validation Error -->
                <span class="text-danger" id="EmailValdation"></span>
              </div>
              <!-- end form-group -->
              <!-- end form-group -->
              <div class="form-group">
                <label class="fs-14 text-black fw-medium lh-18">Passowrd</label>
                <input type="password" v-model="password" class="form-control form--control" placeholder="Password" />
                <!-- Validation Error -->
                <span class="text-danger" id="PasswordValdation"></span>
              </div>
              <!-- end form-group -->
              <!-- end form-group -->
              <div class="form-group">
              ...
              <div class="form-group">
                <div class="d-flex align-items-center">
                  <div class="custom-control custom-checkbox fs-13 mr-4">
                    ...
                    <label class="custom-control-label custom--control-label lh-18" for="opt-in">Opt-in to receive
                      occasional product updates, user
              ...
              <!-- end form-group -->
              <div class="form-group">
                <button id="send-message-btn" class="btn theme-btn w-100" type="submit">
                  Sign up <i class="la la-arrow-right icon ml-1"></i>
                </button>
              </div>
              <!-- end form-group -->
              <p class="fs-13 lh-18 pb-3">
                By clicking “Sign up”, you agree to our
                <a href="terms-and-conditions.html" class="text-color hover-underline">terms of conditions</a>,
              ...
              <div class="social-icon-box">
                <div class="pb-3 d-flex align-items-center">
                  ...
                  <span class="mx-2 text-gray-2 fw-medium text-uppercase fs-14">or</span>
                  <hr class="flex-grow-1 border-top-gray" />
                </div>
                <button class="
                    btn
