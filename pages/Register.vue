    ...
    <div class="container">
      <form action="#" class="card card-item">
        <div class="card-body row p-0">
          <div class="col-lg-6">
            <div
              class="form-content p-5 h-100 d-flex align-items-center justify-content-center flex-column bg-diagonal-gradient-primary-2 radius-top-left-8 radius-bottom-left-8 text-left">
              ...
              <div class="hero-list w-100">
                ...
                <div class="d-flex align-items-center pb-30px">
                  ...
                  <p class="fs-15 text-white lh-20 fw-medium">Unlock new privileges like voting and
                    commenting</p>
                </div>
                <div class="d-flex align-items-center pb-30px">
                  <svg width="26" height="26" class="mr-2">
                  ...
                  <p class="fs-15 text-white lh-20 fw-medium">Save your favorite tags, filters, and
                    jobs</p>
                </div>
          ...
          <div class="col-lg-5 mx-auto">
            <div class="form-action-wrapper py-5">
                ...
                <div class="d-flex align-items-center">
                  <div class="custom-control custom-checkbox fs-13 mr-4">
                    ...
                    <label class="custom-control-label custom--control-label lh-18" for="opt-in">Opt-in to receive
                      occasional product updates, user research
                      invitations, company announcements, and digests.</label>
                  </div>
                  ...
                  <div class="generic-popover d-none">
                    <p class="pb-2 fs-14">We know you hate spam, and we do too. That’s why we make
                      it easy for you to update your email preferences or unsubscribe at anytime.
                    </p>
              ...
              <p class="fs-13 lh-18 pb-3">By clicking “Sign up”, you agree to our <a href="terms-and-conditions.html"
                  class="text-color hover-underline">terms of
                  conditions</a>, <a href="privacy-policy.html" class="text-color hover-underline">privacy policy</a>
              </p>
              <div class="social-icon-box">
                ...
                <button class="btn theme-btn google-btn d-flex align-items-center justify-content-center w-100 mb-2"
                  type="button">
                ...
                <button class="btn theme-btn facebook-btn d-flex align-items-center justify-content-center w-100 mb-2"
                  type="button">
                  <span class="btn-icon"><svg focusable="false" width="16px" height="16px"
                ...
                <button class="btn theme-btn twitter-btn d-flex align-items-center justify-content-center w-100"
                  type="button">
                  <span class="btn-icon"><svg focusable="false" width="16px" height="16px"
