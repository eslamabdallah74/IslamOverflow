...
<template>
  <section class="login-area pt-100px pb-80px position-relative">
      ...
      <div class="card-body row p-0">
        <div class="col-lg-6">
          ...
          >
            ...
            <a
              href="signup.html"
              class="btn theme-btn theme-btn-white px-5 lh-24"
              >Sign up</a
            >
          </div>
        </div>
            ...
            <div class="form-action-wrapper py-5">
              ...
              >
                ...
                <a
                  ...
                  class="btn-text fs-14 hover-underline fw-regular"
                  >Forgot Password?</a
                >
              </div>
              <!-- end form-group -->
              <div class="form-group">
                ...
                <div
                  style="text-align: center; color: brown; font-weight: bold"
                >
                  {{ errorMessage }}
                </div>
              </div>
    ...
    <!-- end container -->
    <svg
      class="position-absolute bottom-0 left-0 w-100 z-index-n1"
      id="wave"
