  ...
  <section class="login-area pt-100px pb-80px position-relative">
    <div class="container">
        ...
        <div class="col-lg-6">
          <div class="
            ...
            <p class="text-white fs-18">
              Log in with your information that you entered <br />
              during your registration.
            </p>
            <p class="text-white text-center pt-60px pb-3">
            ...
            <div class="form-action-wrapper py-5">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <div class="input-group-append">
                    <button class="
                        btn
                        theme-btn-outline theme-btn-outline-gray
                        toggle-password
                      " type="button">
              ...
              <div class="form-group">
                <button id="send-message-btn" class="btn theme-btn w-100" type="submit">
                  Log in <i class="la la-arrow-right icon ml-1"></i>
                </button>
                <div style="text-align: center; color: brown; font-weight: bold">
                  {{ errorMessage }}
                </div>
              </div>
              <!-- end form-group -->
      ...
      <p class="text-black text-center fs-15">
        Don’t have an account?
        <a href="signup.html" class="text-color hover-underline">Sign up</a>
      </p>
    </div>
    <!-- end container -->
