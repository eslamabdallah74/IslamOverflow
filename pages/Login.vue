        ...
        <div class="container">
            <form action="#" class="card card-item login-form">
                <div class="card-body row p-0">
                    <div class="col-lg-6">
                        <div
                            class="form-content p-4 h-100 d-flex align-items-center justify-content-center flex-column bg-diagonal-gradient-primary radius-top-left-8 radius-bottom-left-8 text-center">
                            <h3 class="fs-35 pb-3 fw-bold text-white">Good to see you again</h3>
                            <p class="text-white fs-18">Log in with your information that you entered
                                <br> during your registration.
                            </p>
                            <p class="text-white text-center pt-60px pb-3">Don't have an account?</p>
                            <a href="signup.html" class="btn theme-btn theme-btn-white px-5 lh-24">Sign up</a>
                        </div>
                    </div><!-- end col-lg-6 -->
                    <div class="col-lg-5 mx-auto">
                        <div class="form-action-wrapper py-5">
                            ...
                            <div class="form-group d-flex align-items-center justify-content-between">
                                ...
                                <a href="recover-password.html" class="btn-text fs-14 hover-underline fw-regular">Forgot
                                    Password?</a>
                            </div><!-- end form-group -->
                            <div class="form-group">
                                <button id="send-message-btn" class="btn theme-btn w-100" type="submit">Log in <i
            ...
            <p class="text-black text-center fs-15">Don’t have an account? <a href="signup.html"
                    class="text-color hover-underline">Sign up</a></p>
        </div><!-- end container -->
        <svg class="position-absolute bottom-0 left-0 w-100 z-index-n1" id="wave" viewBox="0 0 1440 490" version="1.1"
