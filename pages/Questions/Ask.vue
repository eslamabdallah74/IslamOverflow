                        ...
                        <div class="card card-item">
                            <form method="post" class="card-body">
                                <div class="input-box">
                                    ...
                                    <p class="fs-13 pb-3 lh-20">Be specific and imagine you’re asking a question to
                                        another person</p>
                                ...
                                <div class="input-box">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div>
                                            ...
                                            <p class="fs-13 pb-3 lh-20">Add up to 5 tags to describe what your question
                                                is about:</p>
                                        </div>
                                        <button type="button"
                                        ...
                                        <div class="generic-popover d-none">
                                            ...
                                            <p class="pb-2 fs-14">Tags help the right people find and answer your
                                                question.</p>
                                            <ul class="generic-list-item generic-list-item-bullet">
                                                <li class="lh-18 text-black-50">Identify your tags by completing the
                                                    sentence, "My question is about…"</li>
                                                <li class="lh-18 text-black-50">Include tags that are crucial to your
                                                    question only, like <div class="tag-link">c#</div>
                                                </li>
                                                <li class="lh-18 text-black-50">Only include version numbers, like <div
                                                        class="tag-link">c#-4.0</div>, when absolutely necessary</li>
                                                <li class="lh-18 text-black-50">Use existing <a href="#"
                                                        class="d-inline-block text-color hover-underline"
                                                        target="_blank">popular tags</a></li>
                                            </ul>
                                            <p class="pb-1 fs-14">If you can’t find a tag:</p>
                                            <p class="fs-14 text-black-50"><a href="#"
                                                    class="text-color hover-underline" target="_blank">Create new
                                                    tags</a> or post without it and <a href="#"
                                                    class="text-color hover-underline" target="_blank">ask the
                                                    community</a>
                                    ...
                                    <div class="card">
                                        <div class="card-header" id="headingOne">
                                            <button class="btn btn-link fs-15" data-toggle="collapse"
                                                ...
                                                <span><span class="text-color pr-2 fs-16">1.</span> Summarize the
                                                    problem</span>
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                            ...
                                            <div class="card-body">
                                                <ul
                                                    class="generic-list-item generic-list-item-bullet generic-list-item--bullet-2 fs-14">
                                    ...
                                    <div class="card">
                                        <div class="card-header" id="headingTwo">
                                            <button class="btn btn-link collapsed fs-15" data-toggle="collapse"
                                                ...
                                                <span><span class="text-color pr-2 fs-16">2.</span> Describe what you’ve
                                                    tried</span>
                                                <i class="la la-angle-down collapse-icon"></i>
                                            </button>
                                        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-header" id="headingThree">
                                            <button class="btn btn-link collapsed fs-15" data-toggle="collapse"
                                                ...
                                                <span><span class="text-color pr-2 fs-16">3.</span> Show some
                                                    code</span>
                                                <i class="la la-angle-down collapse-icon"></i>
                                            </button>
                                        </div>
                                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree"
                                            ...
                                            <div class="card-body">
                                                <p class="fs-14 lh-22 text-black-50">
                                                    ...
                                                    <a href="#" class="text-color hover-underline">minimum</a>, <a
                                                        href="#" class="text-color hover-underline">reproducible
                                                        example</a>)
                                                </p>
                                            </div>
                                        </div>
                            ...
                            <div id="accordion-two" class="generic-accordion">
                                    ...
                                    <div id="collapseFour" class="collapse" aria-labelledby="headingFour"
                                        ...
                                        <div class="card-body">
                                            <p class="fs-14 lh-22 text-black-50 pb-2">
                                                <a class="text-color hover-underline d-block" href="#"
                                                    target="_blank">Super user</a>
                                                Troubleshooting hardware and software issues
                                            </p>
                                            <p class="fs-14 lh-22 text-black-50 pb-2">
                                                <a class="text-color hover-underline d-block" href="#"
                                                    target="_blank">Software engineering</a>
                                                For software development methods and process questions
                                            </p>
                                            <p class="fs-14 lh-22 text-black-50 pb-2">
                                                <a class="text-color hover-underline d-block" href="#"
                                                    target="_blank">Hardware recommendations</a>
                                            </p>
                                            <p class="fs-14 lh-22 text-black-50 pb-2">
                                                <a class="text-color hover-underline d-block" href="#"
                                                    target="_blank">Software recommendations</a>
                                            </p>
                                            <p class="fs-14 lh-22 text-black-50">Ask questions about the site on <a
                                                    class="text-color hover-underline" href="#" target="_blank">meta</a>
                                            </p>
                                        </div>
                                    </div>
                                </div><!-- end card -->
                                <div class="card">
                                    ...
                                    <div id="collapseFive" class="collapse" aria-labelledby="headingFive"
                                        ...
                                        <div class="card-body">
                                            <p class="fs-14 lh-22 text-black-50 pb-2">
                                                Find more information about <a class="text-color hover-underline"
                                                    href="#" target="_blank">how to ask a good question here</a>
                                            </p>
                                            <p class="fs-14 lh-22 text-black-50">
                                                Visit the <a class="text-color hover-underline" href="#"
