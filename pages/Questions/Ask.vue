                  ...
                  <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="generic-popover d-none">
                      ...
                      <ul class="generic-list-item generic-list-item-bullet">
                        ...
                        <li class="lh-18 text-black-50">Only include version numbers, like <div class="tag-link">c#-4.0
                          </div>, when absolutely necessary</li>
                        <li class="lh-18 text-black-50">Use existing <a href="#"
                            class="d-inline-block text-color hover-underline" target="_blank">popular tags</a></li>
                      </ul>
                      <p class="pb-1 fs-14">If you can’t find a tag:</p>
                      <p class="fs-14 text-black-50"><a href="#" class="text-color hover-underline"
                          target="_blank">Create new
                          tags</a> or post without it and <a href="#" class="text-color hover-underline"
                          target="_blank">ask the
                          community</a>
                ...
                <div class="input-box pt-2">
                  <div class="form-group">
                    <div class="custom-control custom-checkbox fs-13">
                      ...
                      <label class="custom-control-label custom--control-label" for="youAgreeCheckBox">By asking your
                        question, you agree to the <a href="privacy-policy.html"
              ...
              <div id="accordion-two" class="generic-accordion">
                ...
                <div class="card">
                  ...
                  <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordion-two">
                    <div class="card-body">
                      <p class="fs-14 lh-22 text-black-50 pb-2">
                        Find more information about <a class="text-color hover-underline" href="#" target="_blank">how
                          to ask a good question here</a>
                      </p>
                      <p class="fs-14 lh-22 text-black-50">
