                ...
                <div class="col-lg-2 pr-0">
                    <div class="sidebar pb-45px position-sticky top-0">
                        <ul class="generic-list-item generic-list-item-highlight fs-15">
                            ...
                            <li class="lh-26 active"><a href="home-3.html"><i
                                        class="la la-globe mr-1 text-black"></i>أسئلة </a></li>
                            <li class="lh-26"><a href="tags-list.html"><i
                                        class="la la-tags mr-1 text-black"></i>العلامات </a></li>
                            <li class="lh-26"><a href="user-list.html"><i
                                        class="la la-user mr-1 text-black"></i>المستخدمون </a></li>
                            <li class="lh-26"><a href="badges-list.html"><i
                                        class="la la-id-badge mr-1 text-black"></i>شارات </a></li>
                    ...
                    <div class="question-main-bar border-right border-right-gray pb-50px">
                        ...
                        <div class="questions-snippet border-top border-top-gray">
                            ...
                            <div
                                ...
                                <div class="media-body">
                                    <h5 class="mb-2 fw-medium"><span
                                            class="badge bg-success mr-2 text-white fs-13">+100</span><a
