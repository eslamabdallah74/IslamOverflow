        ...
        <div class="col-lg-2 pr-0">
          <div class="sidebar pb-45px position-sticky top-0">
            <ul class="generic-list-item generic-list-item-highlight fs-15">
              <li class="lh-26"><a href="index.html"><i class="la la-home mr-1 text-black"></i>منزل، بيت
                </a></li>
              <li class="lh-26 active"><a href="home-3.html"><i class="la la-globe mr-1 text-black"></i>أسئلة </a></li>
              <li class="lh-26"><a href="tags-list.html"><i class="la la-tags mr-1 text-black"></i>العلامات </a></li>
              <li class="lh-26"><a href="user-list.html"><i class="la la-user mr-1 text-black"></i>المستخدمون </a></li>
              <li class="lh-26"><a href="badges-list.html"><i class="la la-id-badge mr-1 text-black"></i>شارات </a></li>
              <li class="lh-26"><a href="category-list.html"><i class="la la-sort mr-1 text-black"></i>
                  فئات</a></li>
              <li class="lh-26"><a href="job-list.html"><i class="la la-mouse mr-1 text-black"></i>وظائف
                </a></li>
              <li class="lh-26"><a href="companies.html"><i class="la la-briefcase mr-1 text-black"></i>
                  شركات</a></li>
            </ul>
          </div><!-- end sidebar -->
        </div><!-- end col-lg-2 -->
        <div class="col-lg-7 px-0">
          <div class="question-main-bar border-right border-right-gray pb-50px">
            <div class="filters pb-4 pl-3 d-flex align-items-center justify-content-between">
              <div class="mr-3">
                <h3 class="fs-18 fw-medium">كل الأسئلة</h3>
                <p class="pt-1 fs-14 fw-medium lh-20">21287 سؤالا</p>
              </div>
            ...
            <div class="questions-snippet border-top border-top-gray">
              <div
                ...
                <div class="votes text-center votes-2">
                  <div class="vote-block">
                    ...
                    <span class="vote-text d-block fs-13 lh-18">أصوات</span>
                  </div>
                  <div class="answer-block answered my-2">
                    <span class="answer-counts d-block lh-20 fw-medium">3</span>
                    <span class="answer-text d-block fs-13 lh-18">الإجابات</span>
                  </div>
                  <div class="view-block">
                    <span class="view-counts d-block lh-20 fw-medium">12</span>
                    <span class="view-text d-block fs-13 lh-18">الآراء</span>
                  </div>
                </div>
                <div class="media-body">
                  <h5 class="mb-2 fw-medium"><a href="question-details.html">هل هذا صحيح أثناء إيجاد
                      الوقت المعقد للخوارزمية</a></h5>
                  <p class="mb-2 truncate lh-20 fs-15">هناك حقيقة مثبتة منذ زمن طويل وهي أن المحتوى
                  ...
                  <div class="media media-card user-media align-items-center px-0 border-bottom-0 pb-0">
                    ...
                    <div class="media-body d-flex flex-wrap align-items-center justify-content-between">
                      <div>
                        <h5 class="pb-1"><a href="user-profile.html">أردن سميث</a></h5>
                      ...
                      <small class="meta d-block text-right">
                        <span class="text-black d-block lh-18">طلبت</span>
                        <span class="d-block lh-18 fs-12">منذ 6 ساعات</span>
                      </small>
                    </div>
                  </div>
                </div>
              ...
              <div
                ...
                <div class="votes text-center votes-2">
                  ...
                  <div class="answer-block my-2">
                    ...
                    <span class="answer-text d-block fs-13 lh-18">إجابه</span>
                  </div>
                  <div class="view-block">
                    <span class="view-counts d-block lh-20 fw-medium">12</span>
                    <span class="view-text d-block fs-13 lh-18">الآراء</span>
              ...
              <div
                ...
                <div class="media-body">
                  <h5 class="mb-2 fw-medium"><span class="badge bg-success mr-2 text-white fs-13">+100</span><a
                      href="question-details.html">هل هذا صحيح أثناء إيجاد الوقت المعقد
                      للخوارزمية</a></h5>
                  <p class="mb-2 truncate lh-20 fs-15">هناك حقيقة مثبتة منذ زمن طويل وهي أن المحتوى
                    المقروء لصفحة ما سيلهي القارئ عن التركيز على الشكل الخارجي للنص أو شكل توضع
                    الفقرات في الصفحة التي يقرأها.</p>
              ...
              <div
                ...
                <div class="votes text-center votes-2">
                  ...
                  <div class="view-block">
                    <span class="view-counts d-block lh-20 fw-medium">12</span>
                    <span class="view-text d-block fs-13 answerlh-18">الآراء</span>
                  </div>
                </div>
                <div class="media-body">
                  <h5 class="mb-2 fw-medium"><a href="question-details.html">هل هذا صحيح أثناء إيجاد
            ...
            <div class="pager d-flex flex-wrap align-items-center justify-content-between pt-30px px-3">
              <div>
                ...
                <p class="fs-13 pt-2">عرض 1-10 نتيجة من 50،577 سؤال</p>
              </div>
              <div class="filter-option-box w-20">
                <select class="select-container">
                  <option selected="" value="10">10 لكل صفحة</option>
                  <option value="15">15 لكل صفحة</option>
                  <option value="20">20 لكل صفحة</option>
                  <option value="30">30 لكل صفحة</option>
                  <option value="40">40 لكل صفحة</option>
        ...
        <div class="col-lg-3">
          <div class="sidebar">
            <div class="card card-item">
              <div class="card-body">
                <h3 class="fs-17 pb-3">أسئلة ذات صلة</h3>
                <div class="divider"><span></span></div>
                <div class="sidebar-questions pt-3">
                  <div class="media media-card media--card media--card-2">
                    <div class="media-body">
                      <h5><a href="question-details.html">استخدام web3 لاستدعاء عقد ما قبل التحويل
                          البرمجي</a></h5>
                      <small class="meta">
                        <span class="pr-1">منذ 1 ساعة</span>
                        <span class="pr-1">. بواسطة</span>
                  ...
                  <div class="media media-card media--card media--card-2">
                    <div class="media-body">
                      <h5><a href="question-details.html">هل هذا صحيح أثناء إيجاد الوقت المعقد
                          للخوارزمية</a></h5>
                      <small class="meta">
                        <span class="pr-1">منذ 1 ساعة</span>
                        <span class="pr-1">. بواسطة</span>
            ...
            <div class="card card-item">
              <div class="card-body">
                <h3 class="fs-17 pb-3">العلامات ذات الصلة</h3>
                <div class="divider"><span></span></div>
                <div class="tags pt-4">
                  <div class="tag-item">
            ...
            <div class="ad-card">
              <h4 class="text-gray text-uppercase fs-13 pb-3 text-center">الإعلانات</h4>
