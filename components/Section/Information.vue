<template>
    <div>
        <section class="get-started-area section--padding pattern-bg" id="for-developers">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-title pb-3">للمطورين ، من قبل المطورين</h2>
                    <p class="section-desc w-50 mx-auto">Disilab هو مجتمع مفتوح لأي شخص يرمز. نحن نساعدك في الحصول على
                        إجابات
                        لأصعب أسئلة الترميز ، شارك المعرفة مع زملائك في العمل على انفراد ،
                        وابحث عن وظيفة أحلامك التالية.</p>
                </div>
                    ...
                    <div class="col-lg-4 responsive-column-half">
                        <div class="card card-item hover-y text-center">
                            <div class="card-body">
                                    ...
                                    <g>
                                        <g>
                                            <polygon style="fill:#F0BC5E;"
                                                points="18,36 18,24 11,24 11,41 47,41 47,36   ">
                                            </polygon>
                                        </g>
                                        <g>
                                            <g>
                                ...
                                <h5 class="card-title pt-4 pb-2">أسئلة وأجوبة عامة</h5>
                                <p class="card-text pb-4">هذا مجرد نص بسيط تم إنشاؤه لهذا القالب الفريد والرائع ، يمكنك
                                    تحريره بسهولة كما تريد.</p>
                                <a href="home-2.html" class="btn theme-btn">تصفح الأسئلة <i
                    ...
                    <div class="col-lg-4 responsive-column-half">
                        <div class="card card-item hover-y text-center">
                            <div class="card-body">
                                ...
                                <h5 class="card-title pt-4 pb-2">سؤال وجواب خاص</h5>
                                <p class="card-text pb-4">هذا مجرد نص بسيط تم إنشاؤه لهذا القالب الفريد والرائع ، يمكنك
                                    تحريره بسهولة كما تريد.</p>
                                <a href="free-demo.html" class="btn theme-btn bg-3">حاول مجانا <i
                                        class="la la-arrow-right icon ml-1"></i></a>
                            </div><!-- end card-body -->
                        </div><!-- end card -->
                    </div><!-- end col-lg-4 -->
                    <div class="col-lg-4 responsive-column-half">
                        <div class="card card-item hover-y text-center">
                            <div class="card-body">
                                ...
                                <h5 class="card-title pt-4 pb-2">تصفح الوظائف</h5>
                                <p class="card-text pb-4">هذا مجرد نص بسيط تم إنشاؤه لهذا القالب الفريد والرائع ، يمكنك
                                    تحريره بسهولة كما تريد.</p>
                                <a href="careers.html" class="btn theme-btn">ابحث عن وظيفة <i
                                        class="la la-arrow-right icon ml-1"></i></a>
                            </div><!-- end card-body -->
                        </div><!-- end card -->
                    </div><!-- end col-lg-4 -->
        ...
        <section class="get-started-area section--padding bg-gray" id="for-businesses">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-title pb-3">ما نقدمه</h2>
                </div>
                <div class="row pt-50px">
                    <div class="col-lg-4 responsive-column-half">
                        <div class="media media-card align-items-center hover-s">
                            ...
                            <div class="media-body">
                                <h5 class="pb-2"><a href="free-demo.html">سؤال وجواب </a></h5>
                                <p>اعثر على المعرفة وشاركها مع الجميع </p>
                            </div>
                        </div>
                    </div><!-- end col-lg-4 -->
                    <div class="col-lg-4 responsive-column-half">
                        <div class="media media-card align-items-center hover-s">
                            ...
                            <div class="media-body">
                                <h5 class="pb-2"><a href="talent.html">حلول المواهب</a></h5>
                                <p>اعثر على المرشح المثالي لفريقك الفني المتنامي</p>
                            </div>
                        </div>
                    </div><!-- end col-lg-4 -->
                    <div class="col-lg-4 responsive-column-half">
                        <div class="media media-card align-items-center hover-s">
                            ...
                            <div class="media-body">
                                <h5 class="pb-2"><a href="advertising.html">منصة إعلانية</a></h5>
                                <p>تسريع اكتشاف منتجاتك أو خدماتك</p>
                            </div>
                        </div>
                    </div><!-- end col-lg-4 -->
                </div><!-- end row -->
