            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="hero-content d-flex align-items-center">
                        ...
                        <h2 class="section-title fs-30">إعدادات</h2>
                    </div><!-- end hero-content -->
                </div><!-- end col-lg-8 -->
                <div class="col-lg-4">
                    <div class="hero-btn-box text-right py-3">
                        <a href="user-profile.html" class="btn theme-btn theme-btn-outline theme-btn-outline-gray"><i
                                class="la la-user mr-1"></i> عرض الصفحة الشخصية</a>
                    </div>
                </div><!-- end col-lg-4 -->
            </div><!-- end row -->
